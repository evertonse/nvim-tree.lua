...
local function _draw(bufnr, lines, hl_args, signs, extmarks, size_extmarks, virtual_lines)
...
function M.draw()
  ...
  _draw(bufnr, M.builder.lines, M.builder.hl_args, M.builder.signs, M.builder.extmarks, M.builder.size_extmarks, M.builder.virtual_lines)
